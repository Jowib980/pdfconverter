  ...
  return (
    ...
    <div className="content">
        ...
        <div className="selected-section flex min-h-screen bg-gray-50 mt-4 py-6">
              ...
              {selectedFiles.map((file, index) => (
                 <div key={index} className="bg-white p-4 rounded-xl shadow-lg flex flex-col items-center w-40 relative group">
                  ...
                  <div className="file_canvas">
                    <canvas width="127" height="180" className="ppt"></canvas>
                  </div>
          ...
          {selectedFiles.length > 0 ? (
            ...
            <div className="p-6 text-center border-b">
              <h1 className="tool-heading text-xl font-semibold">POWERPOINT to PDF</h1>
            </div>
            <div className="p-6">
              <button
              ...
              <div className="relative flex flex-1 items-center justify-center overflow-hidden bg-gray-500">
                ...
                <div className="absolute inset-0 p-6 opacity-20 pointer-events-none">
                  <h1 className="text-xl font-semibold text-center tool-heading">PPT to PDF</h1>
      ...
      {isConverting && (
        ...
        <h1 className="section-title">POWERPOINT file convert to PDF</h1>
          <h2 className="text-2xl font-semibold mb-4">Converting your POWERPOINT files...</h2>
          <Loader />
        </div>
      )}
